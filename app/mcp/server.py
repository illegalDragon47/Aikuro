...
class MCPServer:
    ...
    def __init__(self, name: str = "aikuro"):
    ...
    def run(self, transport: str = "stdio") -> None:
        ...
        logger.info(f"Starting Aikuro Enterprise server ({transport} mode)")
        self.server.run(transport=transport)


def parse_args() -> argparse.Namespace:
    """Parse command line arguments for server configuration."""
    parser = argparse.ArgumentParser(description="Aikuro Enterprise MCP Server")
    parser.add_argument(
        "--transport",
        choices=["stdio"],
        default="stdio",
